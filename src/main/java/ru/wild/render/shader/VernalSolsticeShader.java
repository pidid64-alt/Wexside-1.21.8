...
public final class VernalSolsticeShader implements AutoCloseable {
   private static final VernalSolsticeShader instance = new VernalSolsticeShader();
   private static final String data = "assets/wild/shaders/mainmenu/menu_quad.vert";
   private static final String context = "assets/wild/shaders/mainmenu/vernal_solstice.frag";
   ...
   public static VernalSolsticeShader handle() {
      return instance;
   }
   public void handle(int var1, int var2, float var3, float var4, ThemeColors var5, float var6) {
      if (var1 > 0 && var2 > 0) {
         ...
         try {
            ...
            int var13 = var5 == null ? -13447886 : var5.save();
            int var14 = var5 == null ? -10496 : var5.submit();
            ...
            this.cache.handle("uAlpha", this.handle(var6) * 0.76F);
            this.cache.handle("uLightMode", 1.0F);
   ...
   private void process() {
      ...
      if (this.cache == null) {
         this.cache = this.config
            .handle("vernal_solstice_click_gui", "assets/wild/shaders/mainmenu/menu_quad.vert", "assets/wild/shaders/mainmenu/vernal_solstice.frag");
      }
   }
