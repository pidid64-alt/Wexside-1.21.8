...
public final class GlacierVeilShader implements AutoCloseable {
   private static final GlacierVeilShader instance = new GlacierVeilShader();
   private static final String data = "assets/wild/shaders/mainmenu/menu_quad.vert";
   private static final String context = "assets/wild/shaders/mainmenu/glacier_veil.frag";
   ...
   public static GlacierVeilShader handle() {
      return instance;
   }
   public void handle(int var1, int var2, float var3, float var4, ThemeColors var5, float var6) {
      if (var1 > 0 && var2 > 0) {
         ...
         try {
            ...
            int var13 = var5 == null ? -5706497 : var5.save();
            int var14 = var5 == null ? -12681729 : var5.submit();
   ...
   private void process() {
      ...
      if (this.cache == null) {
         this.cache = this.config
            .handle("glacier_veil_click_gui", "assets/wild/shaders/mainmenu/menu_quad.vert", "assets/wild/shaders/mainmenu/glacier_veil.frag");
      }
   }
