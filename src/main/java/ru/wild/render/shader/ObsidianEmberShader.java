...
public final class ObsidianEmberShader implements AutoCloseable {
   private static final ObsidianEmberShader instance = new ObsidianEmberShader();
   private static final String data = "assets/wild/shaders/mainmenu/menu_quad.vert";
   private static final String context = "assets/wild/shaders/mainmenu/obsidian_ember.frag";
   ...
   public static ObsidianEmberShader handle() {
      return instance;
   }
   public void handle(int var1, int var2, float var3, float var4, ThemeColors var5, float var6) {
      if (var1 > 0 && var2 > 0) {
         ...
         try {
            ...
            int var13 = var5 == null ? -20119 : var5.save();
            int var14 = var5 == null ? -42198 : var5.submit();
   ...
   private void process() {
      ...
      if (this.cache == null) {
         this.cache = this.config
            .handle("obsidian_ember_click_gui", "assets/wild/shaders/mainmenu/menu_quad.vert", "assets/wild/shaders/mainmenu/obsidian_ember.frag");
      }
   }
