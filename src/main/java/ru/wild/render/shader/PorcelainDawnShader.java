...
public final class PorcelainDawnShader implements AutoCloseable {
   private static final PorcelainDawnShader instance = new PorcelainDawnShader();
   private static final String data = "assets/wild/shaders/mainmenu/menu_quad.vert";
   private static final String context = "assets/wild/shaders/mainmenu/porcelain_dawn.frag";
   ...
   public static PorcelainDawnShader handle() {
      return instance;
   }
   public void handle(int var1, int var2, float var3, float var4, ThemeColors var5, float var6) {
      if (var1 > 0 && var2 > 0) {
         ...
         try {
            ...
            int var13 = var5 == null ? -9816 : var5.save();
            int var14 = var5 == null ? -19589 : var5.submit();
            ...
            this.cache.handle("uAlpha", this.handle(var6) * 0.85F);
   ...
   private void process() {
      ...
      if (this.cache == null) {
         this.cache = this.config
            .handle("porcelain_dawn_click_gui", "assets/wild/shaders/mainmenu/menu_quad.vert", "assets/wild/shaders/mainmenu/porcelain_dawn.frag");
      }
   }
