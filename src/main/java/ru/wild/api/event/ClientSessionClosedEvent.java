...
public final class ClientSessionClosedEvent extends Event {
   private final MinecraftClient instance;
   private final Instant data;

   public ClientSessionClosedEvent(MinecraftClient var1) {
      this(var1, Instant.now());
   }

   public ClientSessionClosedEvent(MinecraftClient var1, Instant var2) {
      this.instance = var1;
